...
`;
    ...
    // RENDER (DELOGO SOLO ABAJO, SEGURO)
    execSync(`ffmpeg -y -i video_${i}.mp4 -i audio_fixed_${i}.mp3 -vf "delogo=x=0:y=1000:w=720:h=250,scale=720:1280,ass=subs_${i}.ass" -t 15 -map 0:v -map 1:a -c:v libx264 -preset ultrafast -crf 32 -threads 1 -c:a aac -b:a 96k output_${i}.mp4`);
